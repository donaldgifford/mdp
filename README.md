...
A fast markdown preview server for Neovim with live reload, scroll sync,
and client-side rendering of Mermaid diagrams, KaTeX math, and syntax
highlighting. All assets are embedded in the binary -- no CDN requests at
runtime.
...
The browser opens automatically. Edit the file and save -- the preview
updates instantly.
...
- **Syntax highlighting**: all languages supported by highlight.js with
...
- **Relative images**: images referenced with relative paths are resolved
