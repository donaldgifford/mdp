...
- [Findings](#findings)
  ...
  - [Existing goldmark extensions](#existing-goldmark-extensions)
    - [1. github.com/zmtcreative/gm-alert-callouts (v0.8.0)](#1-githubcomzmtcreativegm-alert-callouts-v080)
    - [2. github.com/thiagokokada/goldmark-gh-alerts](#2-githubcomthiagokokadagoldmark-gh-alerts)
    - [3. gitlab.com/staticnoise/goldmark-callout](#3-gitlabcomstaticnoisegoldmark-callout)
    - [4. github.com/omar0ali/goldmark-alerts (v0.1.0)](#4-githubcomomar0aligoldmark-alerts-v010)
